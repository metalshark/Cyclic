...
public final class UtilFluidHandler {
  ...
  @Nullable
  public static IFluidHandler get(@Nonnull final World world, @Nonnull final BlockPos blockPos, @Nonnull final Direction side) {
    return getOptCap(world, blockPos, side).resolve().orElse(null);
  }

  @Nonnull
  public static LazyOptional<IFluidHandler> getOptCap(@Nonnull final World world, @Nonnull final BlockPos blockPos, @Nonnull final Direction side) {
  ...
  public static IFluidHandler getFromBlock(@Nonnull final World world, @Nonnull final BlockPos blockPos) {
