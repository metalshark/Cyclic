...
public final class UtilItemHandler {
  ...
  @Nullable
  public static IItemHandler get(@Nonnull final World world, @Nonnull final BlockPos blockPos, @Nonnull final Direction side) {
    return getOptCap(world, blockPos, side).resolve().orElse(null);
  }

  @Nonnull
  public static LazyOptional<IItemHandler> getOptCap(@Nonnull final World world, @Nonnull final BlockPos blockPos, @Nonnull final Direction side) {
  ...
  public static int moveItems(@Nonnull final IItemHandler input, final int inputSlot, @Nonnull final IItemHandler output, final int amount) {
