...
public class RecipeSolidifier<T> extends CyclicRecipe {
  ...
  @Override
  public boolean matches(@Nonnull TileEntityBase inv, @Nonnull World worldIn) {
    try {
  ...
  public static class SerializeSolidifier extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<RecipeSolidifier<? extends TileEntityBase>> {
    ...
    @Override
    public RecipeSolidifier<? extends TileEntityBase> read(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
    ...
    @Override
    public RecipeSolidifier<? extends TileEntityBase> read(@Nonnull final ResourceLocation recipeId, @Nonnull final PacketBuffer buffer) {
    ...
    @Override
    public void write(@Nonnull final PacketBuffer buffer, @Nonnull final RecipeSolidifier recipe) {
